...
var createUser = {
  queries: [
    {
      query:
        "INSERT INTO api.users (firstname, lastname, username, email) VALUES ( $1, $2, $3, $4);",
      parameters: []
    },
    {
    ...
    {
      query:
        "INSERT INTO api.groups (username, isGuest, isUser, isAdmin) VALUES ($1, $2, $3, $4);",
      parameters: []
    }
  ]
};

// Returns a config for specific deviceid
var getConfigByDeviceId = {
  query: `SELECT device_name,device_room,device_leds FROM api.devices WHERE device_id = $1;`,
  parameters: []
};
